    ...
    private ArrayList<HashMap<String, Object>> getFeaturedEndpoints(int code){
        ...
        switch (code){
            ...
            case FEATURED_HUNT_CODE_ENGINEERING:
                ...
                /** Point1 - Old Engineering Building
                 * * */
                HashMap<String, Object> campusMap1 = new HashMap<>();
                campusMap1.put("answer", "Old Engineering Building");
                campusMap1.put("hint", "also known as Engineering Block A, is located towards the southern end of uni, along Wilson Avenue. It is a large red brick building that houses multiple engineering design studios as well as a secret rooftop garden!");
                campusMap1.put("task", 1L);
                campusMap1.put("lat", "-37.79939611");
                campusMap1.put("lng", " 144.9615708");
                ...
                campusMap2.put("task", 2L);
                campusMap2.put("lat", "-37.79974896");
                campusMap2.put("lng", "144.96227243");
                endpoints.add(campusMap2);

                /** Point3 - Melbourne Connect
                 * */
                HashMap<String, Object> campusMap3 = new HashMap<>();
                campusMap3.put("answer", "Melbourne Connect");
                campusMap3.put("hint", "partner program offered to select schools in metropolitan and regional Victoria. Activities are focused on empowering students with valuable insights into the transition from high school to university life.");
                campusMap3.put("task", 0L);
                campusMap3.put("lat", "-37.799959687");
                campusMap3.put("lng", "144.964399125");
